...
<div class="section">
  ...
  <p style="font-size:12px;color:#666;margin-bottom:6px;">
    <strong>Sources &amp; provenance (all coordinates T2T-CHM13 v2.0 / GCA_009914755.4):</strong>
    ...
    <strong>ENCODE-style blacklist</strong> &mdash; <em>manually curated with T2T CHM13 v2.0 coordinates</em>
    (no CHM13 version of the Boyle-Lab ENCODE Blacklist exists);
    constructed from the T2T cenSat and telomere tracks above plus acrocentric short arms
    (chr13/14/15/21/22) and chr9 pericentromeric heterochromatin.
    Conceptual framework: Amemiya <em>et al.</em>
    <a href="https://doi.org/10.1038/s41598-019-45839-z" target="_blank" rel="noopener noreferrer">
      <em>Sci Rep</em> 2019;9:9354</a>.
    See <code>resources/blacklists/SOURCES.md</code> for full provenance and T2T download commands.
  </p>
  {chart_html}
  {table_html}
</div>"""
